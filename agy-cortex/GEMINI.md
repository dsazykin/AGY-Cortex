...
**Follow the Chain**: Once `@router` provides a routing decision, follow the "Escalation Chain" and "Visual Branding" protocols defined in the `agy-cortex` extension.
